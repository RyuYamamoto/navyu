...
def generate_launch_description():
  ...
  world_file = os.path.join(get_package_share_directory('navyu_simulator'), 'world', 'willow_garage.world')

  robot_description = launch_ros.descriptions.ParameterValue(
    Command([
      'xacro', ' ', urdf_file, ' ', 'use_ros2_control:=true', ' ', 'sim_mode:=true', ' ', 'gazebo:=true']),
    value_type=str)
  ...
  rviz_config = os.path.join(get_package_share_directory('navyu_simulator'), 'rviz', 'default.rviz')
  rviz_node = Node(
